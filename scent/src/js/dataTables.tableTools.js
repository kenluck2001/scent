...
/*
     FILE ARCHIVED ON 23:13:40 May 8, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 5:57:57 Jun 2, 2016.
 ...
 *   MIT license - /web/20160508231340/http://datatables.net/license/mit
 *
 * This source file is distributed in the hope that it will be useful, but
 * WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY
 * or FITNESS FOR A PARTICULAR PURPOSE. See the license files for details.
 *
 * For details please refer to: /web/20160508231340/http://www.datatables.net
 */
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	getHTML: function(width, height) {
		...
		if (navigator.userAgent.match(/MSIE/)) {
			...
			html += '<embed id="'+this.movieId+'" src="'+ZeroClipboard_TableTools.moviePath+'" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="'+width+'" height="'+height+'" name="'+this.movieId+'" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="/web/20160508231340/http://www.macromedia.com/go/getflashplayer" flashvars="'+flashvars+'" wmode="transparent" />';
		}
		return html;
	},
...
TableTools.buttonBase = {
	...
	"bOpenRows": false,
	"bSelectedOnly": false,
	"oSelectorOpts": undefined, // See /web/20160508231340/http://datatables.net/docs/DataTables/1.9.4/#$ for full options
